...
function Gift() {
    ...
    return (
        ...
        <Container className="my-5">
            <u>
                <h1 className="text-center font-monospace" style={{ fontSize: '20px', color: '#2D2D2D' }}>GIFTING ITEMS</h1>
            </u>
            <p className="featured-description">
                Each product combines timeless craftsmanship with sustainable materials, ensuring a unique, eco-friendly,
                and artistic addition to your home, workspace, or gift collection. Enhance your decor, embrace tradition,
                and celebrate the art of clay today.
            </p>
