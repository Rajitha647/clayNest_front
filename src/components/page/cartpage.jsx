...
import {Grid,Box,Typography,Button,Paper,IconButton,Divider,MenuItem,Select} from '@mui/material';
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={8}>
                        <Paper elevation={3} sx={{ padding: 2 }}>
                            {cartItems.length === 0 ? (
                                <Typography variant="h6" align="center" color="textSecondary" sx={{ padding: 4 }}>
